      ...
      child: Scaffold(
        ...
        body: CustomScrollView(
          slivers: [
            ...
            SliverToBoxAdapter(
              child: Obx(() => Padding(
                padding: const EdgeInsets.fromLTRB(20, 10, 20, 90), // bottom space for buttons
                child: Column(
...
class StepperStickyHeader extends SliverPersistentHeaderDelegate {
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Obx(() {
              ...
              if (controller.currentStep.value == index) {
                circleColor = AppColor.primaryColor;
              } else if (controller.stepCompleted[index]) {
                  ...
                  children: [
                    if (index != 0)
                      SizedBox(
                        ...
                        child: Divider(
                          thickness: 2,
                          color: controller.stepCompleted[index - 1]
                              ? Colors.green
                              : Colors.grey[300],
                        ),
                      ),
                      ...
                      children: [
                        Stack(
                          ...
                          children: [
                            ...
                            if (controller.stepCompleted[index])
                              Positioned(
                                right: 0,
                                bottom: 0,
                                child: Container(
                        ...
                        SizedBox(
                          width: 100,
                          child: Text(
                            _breakTwoWords(controller.titles[index]),
