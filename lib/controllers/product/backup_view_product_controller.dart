...
import '../../models/product/GetProductListByCreatorIdModel.dart';
...
class ViewProductController extends GetxController{
  ...
  var getProductListByCreatorIdModel = Rxn<GetProductListByCreatorIdModel>(); //
  ...
  void  getProductListByCreatorIdApi() async {
    try {
      ...
      if(data['success'] == true){
        ...
        getProductListByCreatorIdModel.value= GetProductListByCreatorIdModel.fromJson(data);
