            ...
            children: [
              ...
              Align(
                alignment: Alignment.center,
                  child: Text("Dashboard", style: TextStyle(color: AppColor.black87),)),
             /* SizedBox(height: 20,),
              Align(
                alignment: Alignment.center,
                child: InkWell(
                  onTap: (){
                    Get.toNamed("/enforcementDashboard");
                  },
                  child: Container(
                    ...
                    child: Center(
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 10,),
                          Text("Enforcement Panel", style: TextStyle(color: AppColor.appWhite),)
                        ],
                      ),
                    ),
                  ),
