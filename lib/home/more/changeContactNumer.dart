...
class ChangeContactNumber extends StatelessWidget {

  ChangeContactController changeContactController = Get.put(ChangeContactController());
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: Form(
        key:  changeContactController.formKey ,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  CustomLabeledTextField(
                                    ...
                                    controller: changeContactController.emailController,
                                    hintText: '',
                                    isRequired: true,
