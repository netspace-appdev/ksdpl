...
class CustomLabeledPickerTextField extends StatelessWidget {
  ...
  final bool enabled;
  final bool isFutureDisabled;
  final bool isPastDateDisabled; // ✅ new flag
  final VoidCallback? onDateSelected;
  ...
  const CustomLabeledPickerTextField({
    ...
    this.enabled = true,
    this.isFutureDisabled = false,
    this.isPastDateDisabled = false, // ✅ default false
    this.onDateSelected,
  }) : super(key: key);
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    DateTime? pickedDate = await showDatePicker(
      context: context,
      initialDate: now,
      firstDate: isPastDateDisabled ? now : DateTime(1900), // ✅ Block past dates
      lastDate: isFutureDisabled ? now : DateTime(2100), // ✅ Block future dates
    );
