class GetAllProductListModel {
  String? status;
  bool? success;
  List<Data>? data;
  String? message;

  GetAllProductListModel({this.status, this.success, this.data, this.message});

  GetAllProductListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
