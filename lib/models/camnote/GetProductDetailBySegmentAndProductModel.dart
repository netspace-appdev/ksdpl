...
class Data {
  ...
  int? ageLimitEarningApplicants;
  int? ageLimitNonEarningCoApplicant;
  int? minimumAgeEarningApplicants;
  int? minimumAgeNonEarningApplicants;
  int? minimumIncomeCriteria;
  int? minimumLoanAmount;
  int? maximumLoanAmount;
  int? minTenor;
  int? maximumTenor;
  int? minimumRoi;
  int? maximumRoi;
  int? maximumTenorEligibilityCriteria;
  String? geoLimit;
  String? negativeProfiles;
  String? negativeAreas;
  int? maximumTat;
  int? minimumPropertyValue;
  int? maximumIir;
  int? maximumFoir;
  int? maximumLtv;
  ...
  int? technicalFee;
  int? adminFee;
  int? foreclosureCharges;
  int? otherCharges;
  double? stampDuty;
  int? tsrYears;
  int? tsrCharges;
  int? valuationCharges;
  int? noOfDocument;
  ...
  int? fromAmountRange;
  int? toAmountRange;
  int? totalOverdueCases;
  int? totalOverdueAmount;
  int? totalEnquiries;
  Null? superiorName;
  Null? superiorMobileNo;
  Null? superiorWhatsappNo;
  Null? superiorEmail;
