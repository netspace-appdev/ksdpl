class SaveCamnoteDetailsModel {
  String? status;
  bool? success;
  Data? data;
  String? message;

  SaveCamnoteDetailsModel({this.status, this.success, this.data, this.message});

  SaveCamnoteDetailsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
