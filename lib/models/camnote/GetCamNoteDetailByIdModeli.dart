class GetCamNoteDetailByIdModel {
  String? status;
  bool? success;
  Data? data;
  String? message;

  GetCamNoteDetailByIdModel({this.status, this.success, this.data, this.message});

  GetCamNoteDetailByIdModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
